...
class WatchedTogetherRecyclerFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_watched_together_recycler, container, false)
        getMovieIds(view)
        val explanation = view.findViewById<TextView>(R.id.youBothWatchedText)
        Handler().postDelayed({
    ...
    fun getMovieIds(view: View){
        ...
        db.collection("users").document(auth.currentUser!!.uid).get().addOnSuccessListener {
            ...
            db.collection("connections").document(connectionId!!).get().addOnSuccessListener {
                ...
                var watchedTogetherIds = connection!!.watchedTogetherIds
                getMovies(watchedTogetherIds!!, view)
            }
        }
